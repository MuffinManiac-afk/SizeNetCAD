...
def length_detection(length_dict, cf, preds, probs,num2class):
    ...
    if ld_tolerance_scope != 0:
        ...
        # cmp_value = estimate_length_dict[cf]
    else:
...
def length_detection_withReal(length_dict, cf, preds, probs, num2class, estimate_length_dict, tolerance_scope):
    ld_tolerance_scope = tolerance_scope
    target_length = length_dict[cf]
